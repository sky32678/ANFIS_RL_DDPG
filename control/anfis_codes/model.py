...
class Anfis(nn.Module):
    ...
    def my_model(self):
        ...
        #                            Zero()])
            ...
            print("MAX's IMPLEMENTATION CREATED")
            invardefs = [
    ...
    ##########################################################
                    ...
                    #                    Zero()]),
                    ('distance_line', [TrapezoidalMembFunc(-100., -100., -1.8, -1.3,1,7),
                                       TrapezoidalMembFunc(-1.8, -1.3, -0.9, -0.6,2,7),
                                       TrapezoidalMembFunc(-0.9, -0.6, -0.3, -0.1,3,7),
                                       TrapezoidalMembFunc( -0.3, -0.1, 0.1, 0.3,4,7),
                                       TrapezoidalMembFunc(0.1, 0.3, 0.6, 0.9,5,7),
                                       TrapezoidalMembFunc(0.6, 0.9, 1.3, 1.8,6,7),
                                       TrapezoidalMembFunc( 1.3, 1.8, 100, 100,7,7),
                                       Zero()]),

                    ('theta_far', [TrapezoidalMembFunc(-np.pi, -np.pi, -1.2, -0.8,1),
                                   TrapezoidalMembFunc( -1.2, -0.8, -0.2, -0.1,2),
                                   TrapezoidalMembFunc(-0.2, -0.1, 0.1, 0.2,3),
                                   TrapezoidalMembFunc( 0.1, 0.2, 0.8, 1.2,4),
                                   TrapezoidalMembFunc( 0.8, 1.2, np.pi, np.pi,5),
                                   Zero()]),

                    ('theta_near', [TrapezoidalMembFunc(-np.pi, -np.pi, -1.0, -0.5,1),
                                    TrapezoidalMembFunc(-1.0, -0.5, -0.12, -0.1,2),
                                    TrapezoidalMembFunc(-0.12, -0.1, 0.1, 0.12,3),
                                    TrapezoidalMembFunc(0.1, 0.12, 0.5, 1.0,4),
                                    TrapezoidalMembFunc(0.5, 1.0, np.pi, np.pi,5),
                                    Zero()]),

                    ('theta_lookahead', [TrapezoidalMembFunc(-np.pi, -np.pi, -1.2, -0.8,1),
                                    TrapezoidalMembFunc( -1.2, -0.8, -0.2, -0.1,2),
                                    TrapezoidalMembFunc(-0.2, -0.1, 0.1, 0.2,3),
                                    TrapezoidalMembFunc(0.1, 0.2, 0.8, 1.2,4),
                                    TrapezoidalMembFunc(0.8, 1.2, np.pi, np.pi,5),
            ...
            mamdani_out = JointSymmetric9TriangleMembership(0,0.45,0.6,1.2,0.9)
