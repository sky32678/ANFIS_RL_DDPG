...
class DDPGagent:
    def __init__(self, num_inputs, num_outputs, anf, hidden_size=32, actor_learning_rate=1e-3, critic_learning_rate=1e-4, gamma=0.99, tau=1e-3, max_memory_size=50000):
        # Params
