...
from anfis_codes.joint_mamdani_membership import JointSymmetricTriangleMembership
    ...
    def my_model(self):
        invardefs = [
                ...
                ('theta_far', [TrapezoidalMembFunc(-3.15, -3.15, -2.3541, -1.2865,1),
                               ...
                               Zero()]),
                ('theta_near', [TrapezoidalMembFunc(-3.15, -3.15, -1.726, -1.0347,1),
                                ...
                                TrapezoidalMembFunc(1.0347, 1.726, 3.15, 3.15,5),
                                Zero()])
