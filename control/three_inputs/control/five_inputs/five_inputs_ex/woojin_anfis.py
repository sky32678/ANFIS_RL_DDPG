...
def my_model():
    ...
    invardefs = [
            ('distance_line', [TrapezoidalMembFunc(-100,-100,-1.425,-0.825,1,5),
                               TrapezoidalMembFunc(-1.425,-0.825,-0.675,-0.075,2,5),
                               TrapezoidalMembFunc(-0.675,-0.075,0.075,0.675,3,5),
                               TrapezoidalMembFunc(0.075, 0.675, 0.825, 1.425,4,5),
                               TrapezoidalMembFunc(0.825, 1.425, 100, 100,5,5),
                               Zero()]),
            #('theta_far', [TrapezoidalMembFunc(-3.15, -3.15, -3.045, -2.205,1,7),
            #               TrapezoidalMembFunc(-3.045, -2.205, -1.995, -1.155,2,7),
            #               TrapezoidalMembFunc(-1.995, -1.155, -0.945, -0.105,3,7),
            #               TrapezoidalMembFunc(-0.945, -0.105, 0.105, 0.945,4,7),
            #               TrapezoidalMembFunc(0.105, 0.945, 1.155, 1.995,5,7),
            #               TrapezoidalMembFunc(1.155, 1.995, 2.205, 3.045,6,7),
            #               TrapezoidalMembFunc(2.205, 3.045, 3.15, 3.15,7,7),
            #               Zero()]),
            ('theta_far', [TrapezoidalMembFunc(-100, -100, -1.71, -0.99,1,5),
                            TrapezoidalMembFunc(-1.71, -0.99, -0.81, -0.09,2,5),
                            TrapezoidalMembFunc(-0.81, -0.09, 0.09, 0.81,3,5),
                            TrapezoidalMembFunc(0.09, 0.81, 0.99, 1.71,4,5),
                            TrapezoidalMembFunc(0.99, 1.71, 100, 100,5,5),
                            Zero()]),
            ('theta_near', [TrapezoidalMembFunc(-100, -100, -1.71, -0.99,1,5),
                            TrapezoidalMembFunc(-1.71, -0.99, -0.81, -0.09,2,5),
                            TrapezoidalMembFunc(-0.81, -0.09, 0.09, 0.81,3,5),
                            TrapezoidalMembFunc(0.09, 0.81, 0.99, 1.71,4,5),
                            TrapezoidalMembFunc(0.99, 1.71, 100, 100,5,5),
                            Zero()]),
            ('theta_lookahead', [TrapezoidalMembFunc(-100, -100, -1.71, -0.99,1,5),
                            TrapezoidalMembFunc(-1.71, -0.99, -0.81, -0.09,2,5),
                            TrapezoidalMembFunc(-0.81, -0.09, 0.09, 0.81,3,5),
                            TrapezoidalMembFunc(0.09, 0.81, 0.99, 1.71,4,5),
                            TrapezoidalMembFunc(0.99, 1.71, 100, 100,5,5),
                            Zero()]),
            #('theta_lookahead', [TrapezoidalMembFunc(-3.15, -3.15, -3.045, -2.205,1,7),
            #               TrapezoidalMembFunc(-3.045, -2.205, -1.995, -1.155,2,7),
            #               TrapezoidalMembFunc(-1.995, -1.155, -0.945, -0.105,3,7),
            #               TrapezoidalMembFunc(-0.945, -0.105, 0.105, 0.945,4,7),
            #               TrapezoidalMembFunc(0.105, 0.945, 1.155, 1.995,5,7),
            ...
            #               TrapezoidalMembFunc(2.205, 3.045, 3.15, 3.15,7,7),
            #               Zero()]),
            ('distance', [TrapezoidalMembFunc(0, 0, 0.5, 1,1,2),
                            TrapezoidalMembFunc(0.5, 1, 100, 100,2,2),
                            Zero()])
...
if __name__ == '__main__':
    ...
    model = my_model()
    ######################################
    num_data, i, o = training_data_selection("5inputs.csv", "5outputs.csv")
